        ...
        <div>
            <nav className="flex justify-between h-16 bg-gray-200 items-center drop-shadow-md">
                ...
                <div className="sm:w-1/3 justify-evenly hidden sm:inline-block">
                    ...
                    <div className="mr-5"><Link to="/signin">Join</Link></div>
                    <div className="h-10 w-24 bg-black text-white items-center text-center justify-center flex rounded-lg"><Link to="/signup">Get Started</Link></div>
                    </div>
                </div>
